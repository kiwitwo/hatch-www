document.getElementById("navarea").innerHTML = `<div class="navbg"></div>
        <div class="nav">
          <div id="logo"><img class="logo" src="https://hatchdotlol.github.io/navbar/img/logo.png" height:30px onclick="location.href='index.html'" /></div>
          <div class="searchimgnav" onclick="searchMade()">
            <img src="https://hatchdotlol.github.io/navbar/img/search.png" id="searchimghard"/>
          </div>
          ...
          <a class="navitem" id="mail" href="/messages.html">
            <img src="https://hatchdotlol.github.io/navbar/img/messages.svg" id="msgsym" /><div id="messagect"><b>1</b></div>
        
          </a>
          <div id="userbox">
          <div id="userinfo"><img id="pfpnav" src="https://uploads.scratch.mit.edu/get_image/user/41022482_96x96.png"><div id="usernamenav">han614698</div><div id="dropdownimgcover"><img id="dropdownarrow" src="https://hatchdotlol.github.io/navbar/img/downarrow.png" /></div></div>
